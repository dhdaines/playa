...
class Document:
    ...
    def _get_pages_from_xrefs(self) -> Iterator[Tuple[int, Dict[str, Dict[str, PDFObject]]]]:
    ...
    def _get_page_objects(self) -> Iterator[Tuple[int, Dict[str, Dict[str, PDFObject]]]]:
